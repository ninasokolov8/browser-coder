...
Drop-in replacement for languages/python/turtle_shim.py.\n\nPreserves the original Browser Coder contract:\n- everything is scoped inside _setup_turtle()\n- output is always __TURTLE_COMMANDS__:<base64-json>\n- no tkinter or third-party dependency is used\n- native SVG backgrounds and moving SVG cursor assets are supported
...
def _setup_turtle() -> None:
    ...
    def _emit_turtle_output() -> None:
        """
        Emit the exact stdout contract used by the original Browser Coder.
        ...
        print(_INLINE_MARKER + encoded_payload)
